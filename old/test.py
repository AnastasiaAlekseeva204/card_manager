...
with GigaChat(credentials="MDE5YTBiMTItOTA3OS03MTg1LWFiMDYtZjQxZTVmNDkyNzFlOjUzMTMyNjU1LWNhNGQtNGVkMy05ZGE2LTFlNDI5MjYxN2FmYQ==", verify_ssl_certs=False) as giga:
    while True:
